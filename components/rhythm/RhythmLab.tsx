...
export function RhythmLab() {
  ...
  const [soundCheckLyricSource, setSoundCheckLyricSource] = useState<"firestore" | "lrclib" | "custom" | "embedded" | "local" | "none">("none");
  ...
  const totalPages = Math.max(1, Math.ceil((totalFound || 0) / 20));
                      ...
                      <div className="chorus-pagination-bar">
                        ...
                        <div className="page-numbers-wrap">
                          ...
                          <span className="page-info-subtext">
                            Halaman <b>{currentPage}</b> dari <b>{totalPages.toLocaleString("id-ID")}</b> ({(totalFound || 0).toLocaleString("id-ID")} Lagu)
                          </span>
                        </div>
        ...
        <MultiplayerLobbyModal
          ...
          onStartMatch={(room) => {
            ...
            if (selectedSong) {
              ...
              if (bestChart) {
                setSelectedChartId(bestChart.id);
              }
            }
